...
- [modelled_unit_composition.md](modelled_unit_composition.md) — the composite ruling
- [vcu_datasheet_verified.md](vcu_datasheet_verified.md) — [P] **"Weight ≤ 660 g" is a CEILING**
- [cirpass_d22_table6.md](cirpass_d22_table6.md) · [cirpass_d21_requirements.md](cirpass_d21_requirements.md)
  · [jensen_2023_data_needs.md](jensen_2023_data_needs.md) · [annex_vi_schema_gap.md](annex_vi_schema_gap.md)
...
- [eu_regulatory_scope.md](eu_regulatory_scope.md) · [elv_regulation_partC_finding.md](elv_regulation_partC_finding.md)
  · [jensen_2023_data_needs.md](jensen_2023_data_needs.md) · [bosch_sources_verified.md](bosch_sources_verified.md)
  · [vcu_datasheet_verified.md](vcu_datasheet_verified.md) · [literature_gaps_ar.md](literature_gaps_ar.md)
...
- [dpp_payload_verified.md](dpp_payload_verified.md) · [registered_research_design.md](registered_research_design.md)
  ...
  · [lca_v4_build_state.md](lca_v4_build_state.md) · [sustainability_scope.md](sustainability_scope.md)
  · [session_history_and_pace.md](session_history_and_pace.md) · [thesis_identity.md](thesis_identity.md)
