...
{
    /// <summary>
    /// RBv2_1_1/03 builder — QR scan entry screen (spec 11 stages 3+4, approved
    ...
    /// either: the Welcome canvas (RBv2_1_1/02) owns entry and calls BeginNewScan().
    /// Re-run RBv2_1_1/02 after RBv2_1_1/03 so the wiring is restored.
    /// </summary>
    public static partial class DPPUIBuilder
    {
        [MenuItem("RBv2_1_1/03 — QR scan screen", false, 3)]
        public static void Build2_QRScanScreen()
        {
            ...
            // everyone who references it. The Welcome canvas (RBv2_1_1/02) holds a
            ...
            Debug.Log("[DPPUIBuilder] RBv2_1_1/03 — QR scan screen built (RBv2.0: no demo fallback). " +
                      "Re-run RBv2_1_1/02 to restore the Welcome wiring (waitForWelcome + firstRunPrompt).");
        }
